...
/**
 * Created by wangmaobo on 2018/6/29.
 */
public class OpenAttachmentsUtils {
    public void openFile(Context context, File file) {
        ...
        try {
            ...
            Intent _intent = Intent.createChooser(intent, "请选择对应的软件打开该附件:");
            context.startActivity(_intent);
        } catch (ActivityNotFoundException e) {
            e.printStackTrace();
            Toast.makeText(context, "无法打开附件，请下载相关软件！", Toast.LENGTH_LONG).show();
        }
    }
