...
public class AutoNewLineLayout extends ViewGroup {
    ...
    private AutoViewClickListener itemClickListener;
        ...
        for (int w = 0, count = getChildCount(); w < count; w++) {
            ...
            childView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    itemClickListener.itemClickListener(finalW);
                }
            });
    ...
    public void setItemClickListener(AutoViewClickListener listener) {
        this.itemClickListener = listener;
    }

    public interface AutoViewClickListener {
